package com.zhang.yong.demothree.ext;
...
public class ShiroExt {
    ...
    public boolean hasAnyRole(String roleNames) {
        ...
        if (subject != null) {
            ...
            // Iterate through roles and check to see if the user has admin of the
            // roles
    ...
    // Shiro权限扩展类声明
    private static ShiroExt shiroExt = null;

    // 以单例模式初始化Shiro权限扩展类对象
    public static ShiroExt getInstance() {
        if(shiroExt == null) {
            shiroExt = new ShiroExt();
        }
        return shiroExt;
    }
